...
module.exports.register = function(twigjs) {
   ...
   */
  twigjs.registerHelper('eachSection', function(query, options) {
   ...
   */
  twigjs.registerHelper('eachRoot', function(options) {
    var buffer = '',
   ...
   * {{/ifNumeric}}
   */
  twigjs.registerHelper('ifNumeric', function(reference, options) {
   ...
   * {{/ifReference}}
   */
  twigjs.registerHelper('ifReference', function(reference, options) {
   ...
   * {{/unlessReference}}
   */
  twigjs.registerHelper('unlessReference', function(reference, options) {
    return (!this.reference || reference != this.reference) ? options.fn(this) : options.inverse(this);
  });
   ...
   * {{/ifDepth}}
   */
  twigjs.registerHelper('ifDepth', function(depth, options) {
   ...
   * {{/unlessDepth}}
   */
  twigjs.registerHelper('unlessDepth', function(depth, options) {
    return (!this.depth || depth != this.depth) ? options.fn(this) : options.inverse(this);
  });
   ...
   */
  twigjs.registerHelper('eachModifier', function() {
    var modifiers,
   ...
   */
  twigjs.registerHelper('eachParameter', function() {
    var parameters,
      options = arguments[arguments.length - 1],
      buffer = '',
      i, l;
   ...
   */
  twigjs.registerHelper('markup', function(options) {
    ...
    template = twigjs.compile('{{> "' + partial.name + '"}}');
    // We don't wrap the rendered template in "new twigjs.SafeString()" since
   ...
   */
  twigjs.registerHelper('overview', function() {
   ...
   */
  twigjs.registerHelper('refDepth', function() {
   ...
   */
  twigjs.registerHelper('rootNumber', function() {
   ...
   */
  twigjs.registerHelper('html', function(arg) {
    throw '{{html expression}} is deprecated; use twigjs’ triple-stash instead: {{{expression}}}.';
  });

  /**
   * Deprecated helper replaced with {{#if markup}}...{{/if}}.
   */
  twigjs.registerHelper('ifAny', function() {
   ...
   */
  twigjs.registerHelper('modifierMarkup', function() {
    throw 'The modifierMarkup twigjs helper is deprecated; if your template has {{modifierMarkup}}, replace it with {{{markup}}}.';
  });

  /**
   * Deprecated helper replaced with {{ifDepth expression}}.
   */
  twigjs.registerHelper('whenDepth', function(depth, options) {
