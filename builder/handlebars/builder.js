...
// If this builder needs to do preparation work before the HTML style guide is
// built, the builder can do its work inside the `prepare()` method. The
// builder has access to the KssStyleGuide object (as the `styleGuide`
...
builder.prepare = function(styleGuide) {
