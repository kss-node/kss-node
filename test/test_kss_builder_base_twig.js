...
describe('KssBuilderBaseTwig object API', function() {
  ...
  describe('KssBuilderBaseTwig constructor', function() {
    ...
    it('should implement the default option definitions', function() {
      let builder = new KssBuilderBaseTwig();
      expect(Object.getOwnPropertyNames(builder.optionDefinitions)).to.deep.equal(['source', 'destination', 'json', 'mask', 'clone', 'builder', 'css', 'js', 'custom', 'extend', 'homepage', 'markup', 'placeholder', 'attributes-placeholder', 'nav-depth', 'verbose', 'extend-drupal8', 'namespace']);
    });
  });
