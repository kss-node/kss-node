 ...
 */
KssSection.prototype.customPropertyNames = function() {
 ...
 */
KssSection.prototype.custom = function(name, value) {
 ...
 */
KssSection.prototype.referenceNumber = function(referenceNumber) {
 ...
 * @returns {KssSection|KssModifier|KssModifier[]|false} If `modifiers` is
 ...
 * @returns {KssSection|KssParameter|KssParameter[]|false} If `parameters` is
 *   given, the `KssSection` object is returned to allow chaining of methods.
