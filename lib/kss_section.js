...
KssSection = function(data) {
  ...
  this.data.deprecated = data.deprecated || false;
  this.data.experimental = data.experimental || false;
  this.data.reference = data.reference || '';
  this.data.autoincrement = data.autoincrement || '';
  this.data.depth = data.depth || 0;
 ...
 *
 * Note: If the header option is disabled this will include the header also.
 *
