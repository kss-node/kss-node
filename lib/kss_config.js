...
let coreOptions = {
  ...
  template: {
    ...
    default:  path.relative(process.cwd(), path.join(__dirname, '..', 'builder', 'handlebars', 'template'))
  },
  css: {
    group:    'Style guide:',
    string:   true,
...
class KssConfig {
   ...
   *
   * Since kss-node is extendable, builders and templates can provide their own
