...
class KssConfig {
   ...
   *
   * @returns {object} An object of configuration options.
   */
  getOptions() {
    return this.options;
  }
   ...
   *   parameter, if one occurs, and the generator object as its second
   *   parameter.
   */
  loadGenerator(cb) {
    let template,
    ...
    generator.checkGenerator(function(error) {
      if (error) {
        return cb(error);
      }
